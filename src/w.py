...
Output:
  output/submission_raw_stable_neural_blend_w73_w56_monthly_cogs.csv
"""
...
def main():
    print("=" * 80)
    print("RAW-ONLY STABLE + OPTIMAL SPLIT + MONTHLY COGS")
    print("=" * 80)
    ...
    out_path = os.path.join(OUT_DIR, "submission_raw_stable_neural_blend_w73_w56_monthly_cogs.csv")
