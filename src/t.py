...
Output:
  output/submission_raw_stable_neural_blend_w735_w565_monthly_cogs_b45.csv
"""
...
TARGET_COGS_RATIO = 0.8450
REV_NEURAL_WEIGHT = 0.735
COGS_NEURAL_WEIGHT = 0.565
...
def main():
    print("=" * 80)
    print("RAW-ONLY STABLE + OPTIMAL SPLIT + STRONG MONTHLY COGS")
    print("=" * 80)
    ...
    out_path = os.path.join(OUT_DIR, "submission_raw_stable_neural_blend_w735_w565_monthly_cogs_b45.csv")
